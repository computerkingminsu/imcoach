...
import { Button, DetailImage, Infor, Price, Title, Wrapper, Writer } from './TennisDetail.style';
...
export default function TennisDetail(): JSX.Element {
  const { post }: any = useGetExerciseDetailPost('tennis');
  ...
  return (
    <>
      ...
      <Wrapper>
        <DetailImage>
          <Image src={post?.detailUrl || '/detailloading.png'} alt="Golf Detail" width={670} height={4250} />
        </DetailImage>
        <Infor>
